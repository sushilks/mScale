...
parser.add_argument('--deployment_id'         , '-i', type=str, help='Each cluster deployment needs to have a unique identifier. \
    ...
    for section in sections:
      if section != "common":
        ...
        for i in range(int(count)):
          ...
          setup_helpers.spawn_instance(instance_name, "ubuntu-14-04", dst_user_name, ssh_key_file, config, machine_type)
